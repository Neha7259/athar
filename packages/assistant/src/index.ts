...
const patterns: ReadonlyArray<{ pattern: RegExp; draft: SourceDraft; message: string }> = [
  {
    ...
    draft: {
      ...
      scope: 'scope2',
      fuelOrEnergyType: 'grid_electricity',
      unit: 'kWh',
      description: 'Purchased electricity from the utility grid',
    },
  ...
  },
  {
    ...
    draft: {
      ipccCategory: 'stationary_combustion',
      scope: 'scope1',
      fuelOrEnergyType: 'diesel',
      unit: 'litre',
      description: 'Fuel consumed in stationary equipment',
    },
  ...
  },
  {
    ...
    draft: {
      ipccCategory: 'purchased_cooling',
      scope: 'scope2',
      fuelOrEnergyType: 'district_cooling',
      unit: 'TR_hour',
      description: 'Purchased district cooling',
    },
  ...
  },
  {
    ...
    draft: {
      ipccCategory: 'fugitive_refrigerants',
      scope: 'scope1',
      fuelOrEnergyType: 'refrigerant',
      unit: 'kg',
      description: 'Refrigerant top-up or fugitive loss',
    },
...
export function suggestSourceDraft(message: string): SourceAssistantResult {
  ...
  if (!match) {
    return {
      ...
      needsConfirmation: true,
      questions: [
        'What fuel or energy is consumed?',
        'Which unit appears on the bill or meter?',
        'Is the equipment owned by the facility or purchased from a utility?',
      ],
    };
  }
  return {
    ...
    needsConfirmation: true,
    questions: [
      'Which facility should receive this source?',
      'Does the unit match the bill or meter?',
      'Please confirm this source before saving it.',
    ],
  };
}
